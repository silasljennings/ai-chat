...
import {
    ...
    primaryKey,
    foreignKey,
    boolean, numeric, decimal, integer,
...
export const user = pgTable('User', {
  ...
  scid: varchar('scid', {length: 128}),
  spid: varchar('spid', {length: 128}),
  credits: integer('credits').default(100)
});

export type User = InferSelectModel<typeof user>;

export const user2fa = pgTable('User2fa', {
    id: uuid('id').primaryKey().notNull().defaultRandom(),
...
export const message = pgTable('Message_v2', {
  ...
  relativeMessageId: varchar('relativeMessageId'),
});
